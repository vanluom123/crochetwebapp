...
usage() {
    ...
    echo "Options:"
    echo "  -e    Set environment (default: local)"
...
MYSQL_CONNECTOR_PATH="D:\\project\\mysql-connector-java-8.0.25\\mysql-connector-java-8.0.25.jar"

# Run updating
if "C:\\Program Files\\liquibase\\liquibase" --defaultsFile=$PROPERTIES_PATH --classpath=$MYSQL_CONNECTOR_PATH update >> $LOG_FILE 2>&1; then
