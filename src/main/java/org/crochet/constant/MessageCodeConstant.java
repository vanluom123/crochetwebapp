...
public class MessageCodeConstant {
    ...
    static {
        ...
        MAP_CODE.put(MessageConstant.CATEGORY_NOT_FOUND_MESSAGE, 5);
        ...
        MAP_CODE.put(MessageConstant.ORDER_PATTERN_DETAIL_NOT_FOUND_FOR_TRANSACTION_ID_MESSAGE, 29);
        MAP_CODE.put(MessageConstant.LOGIN_TO_ORDER_PATTERN_MESSAGE, 30);
        ...
        MAP_CODE.put(MessageConstant.USER_NOT_PAYMENT_FOR_THIS_PATTERN_MESSAGE, 34);
        MAP_CODE.put(MessageConstant.PRODUCT_NOT_FOUND_MESSAGE, 35);
        MAP_CODE.put(MessageConstant.REFRESH_TOKEN_IS_EXPIRED_MESSAGE, 36);
        MAP_CODE.put(MessageConstant.REFRESH_TOKEN_NOT_FOUND_MESSAGE, 37);
        MAP_CODE.put(MessageConstant.EXISTS_AS_A_PARENT_MESSAGE, 38);
        MAP_CODE.put(MessageConstant.EXISTS_AS_A_CHILD_MESSAGE, 39);
