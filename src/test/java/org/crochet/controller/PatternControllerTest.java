...
public class PatternControllerTest {
  ...
  public void testGetPatterns() throws Exception {
    ...
    mockMvc.perform(MockMvcRequestBuilders.get("http://localhost:8080/pattern/pagination")
            .param("pageNo", "1")
            .param("pageSize", "10")
            .param("sortBy", "name")
            .param("sortDir", "asc")
        ...
        .andExpect(MockMvcResultMatchers.jsonPath("$.pageNo").value(1));

    // Verify that the service method was called with the correct parameters
    verify(patternService).getPatterns(1, 10, "name", "asc", "searchText");
  }
}
